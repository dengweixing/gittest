...
public class SmartDialNumberListAdapter extends DialerPhoneNumberListAdapter {
    ...
    protected void setHighlight(ContactListItemView view, Cursor cursor) {
        ...
        /* SPRD: modify resolve NullPointException @{ */
        if (cursor == null || mNameMatcher == null) {
            Exception ex = new NullPointerException("cursor or mNameMatcher is null");
            ex.printStackTrace();
            return;
        }
        if(mNameMatcher == null){
            Log.w(TAG,"setHighlight(),the mNameMatcher is null because configureLoader haven't executed!");
            return;
        }
        /* @} */
