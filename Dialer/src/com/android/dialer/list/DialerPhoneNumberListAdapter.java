...
public class DialerPhoneNumberListAdapter extends PhoneNumberListAdapter {
    ...
    public void setShortcutEnabled(int shortcutType, boolean visible) {
        /** SPRD: Modify for bug325742.
         * @orig mShortcutEnabled[shortcutType] = visible;
         * @{*/
        int oldShortCutCount = getShortcutCount();
        mShortcutEnabled[shortcutType] = visible;

        int newShortCutCount = getShortcutCount();

        if (newShortCutCount != oldShortCutCount) {
