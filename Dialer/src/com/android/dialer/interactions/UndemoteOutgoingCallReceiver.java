...
public class UndemoteOutgoingCallReceiver extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, Intent intent) {
        if (intent != null && Intent.ACTION_NEW_OUTGOING_CALL.equals(intent.getAction())) {
            ...
            /*
             * SPRD: modify
             * * @orig final long id = getContactIdFromPhoneNumber(context, number);
    ...
    private long getContactIdFromPhoneNumber(Context context, String number) {
        ...
        try {
            if (cursor != null && cursor.moveToFirst()) {   // SPRD: modify for NullPointerException
            ...
            if (cursor != null && !cursor.isClosed()) {   // SPRD: modify for NullPointerException
                cursor.close();
            }
        }
    }
