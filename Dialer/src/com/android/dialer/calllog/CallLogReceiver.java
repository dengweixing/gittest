...
public class CallLogReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        if (VoicemailContract.ACTION_NEW_VOICEMAIL.equals(intent.getAction())) {
            ...
            PreloadUtils.getInstance().preloadTouchLocal(context); // SPRD: Add for performance optimization
            PreloadUtils.getInstance().preloadNotTouchLocal(context); // SPRD: Add for performance optimization
        } else {
